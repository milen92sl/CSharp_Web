<?php
/**
 * Blossom Recipe Pro Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Blossom_Recipe_Pro_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Blossom_Recipe_Pro_Repeater_Setting extends WP_Customize_Setting {

<?php
/**
 * Blossom Recipe Pro Custom Control
 * 
 * @package Blossom_Recipe_Pro
*/

if( ! function_exists( 'blossom_recipe_pro_register_custom_controls' ) ) :
/**
 * Register Custom Controls
*/
function blossom_recipe_pro_register_custom_controls( $wp_customize ){    
    ...
    $wp_customize->register_control_type( 'Blossom_Recipe_Pro_Code_Control' );
    $wp_customize->register_control_type( 'Blossom_Recipe_Pro_Radio_Buttonset_Control' );
    $wp_customize->register_control_type( 'Blossom_Recipe_Pro_Radio_Image_Control' );
    $wp_customize->register_control_type( 'Blossom_Recipe_Pro_Select_Control' );
    $wp_customize->register_control_type( 'Blossom_Recipe_Pro_Slider_Control' );
    $wp_customize->register_control_type( 'Blossom_Recipe_Pro_Sortable_Control' );
    $wp_customize->register_control_type( 'Blossom_Recipe_Pro_Toggle_Control' );
    $wp_customize->register_control_type( 'Blossom_Recipe_Pro_Typography_Control' );
}
endif;
add_action( 'customize_register', 'blossom_recipe_pro_register_custom_controls' );
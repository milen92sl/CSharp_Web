<?php
/**
 * Blossom Feminine Pro Customizer Notification System.
 *
 * @package Blossom Feminine Pro
 */
 ...
 */
class Blossom_Feminine_Pro_Customizer_Notice {
	...
	/**
	 * The single instance of Blossom_Feminine_Pro_Customizer_Notice
	 *
	 * @var Blossom_Feminine_Pro_Customizer_Notice $instance The Blossom_Feminine_Pro_Customizer_Notice instance.
	 */
	...
	/**
	 * The Main Blossom_Feminine_Pro_Customizer_Notice instance.
	 *
	 * We make sure that only one instance of Blossom_Feminine_Pro_Customizer_Notice exists in the memory at one time.
	 *
	 * @param array $config The configuration array.
	 */
	public static function init( $config ) {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Blossom_Feminine_Pro_Customizer_Notice ) ) {
			self::$instance = new Blossom_Feminine_Pro_Customizer_Notice;
	...
	public function setup_config() {
		...
		global $blossom_feminine_pro_recommended_plugins;
		...
		$blossom_feminine_pro_recommended_plugins = array();
		
		if ( isset( $this->recommended_plugins ) ) {
			$blossom_feminine_pro_recommended_plugins = $this->recommended_plugins;
		}
	...
	public function scripts_for_customizer() {
		...
		wp_enqueue_style( 'blossom-feminine-pro-customizer-notice', get_template_directory_uri() . '/inc/customizer-plugin-recommend/customizer-notice/css/customizer-notice.css', array(), BLOSSOM_FEMININE_PRO_THEME_VERSION );
		...
		wp_enqueue_script( 'blossom-feminine-pro-customizer-notice', get_template_directory_uri() . '/inc/customizer-plugin-recommend/customizer-notice/js/customizer-notice.js', array( 'customize-controls' ), BLOSSOM_FEMININE_PRO_THEME_VERSION );
		wp_localize_script(
			'blossom-feminine-pro-customizer-notice', 'customizer_notice_data', array(
				'ajaxurl'                  => admin_url( 'admin-ajax.php' ),
				'template_directory'       => get_template_directory_uri(),
				'base_path'                => admin_url(),
				'activating_string'        => __( 'Activating', 'blossom-feminine-pro' ),
			)
		);
	...
	public function customize_register_notice( $wp_customize ) {
		...
		/**
		 * Include the Blossom_Feminine_Pro_Customizer_Notice_Section class.
		 */
		...
		$wp_customize->register_section_type( 'Blossom_Feminine_Pro_Customizer_Notice_Section' );

		$wp_customize->add_section(
			new Blossom_Feminine_Pro_Customizer_Notice_Section(
				$wp_customize,
	...
	public function dismiss_recommended_plugins_callback() {
		...
		if ( ! empty( $action_id ) ) {
			...
			$show_recommended_plugins = get_option( 'blossom_feminine_pro_show_recommended_plugins' );
			...
			update_option( 'blossom_feminine_pro_show_recommended_plugins', $show_recommended_plugins );
		}

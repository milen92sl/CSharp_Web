...
function blossom_feminine_pro_customize_register_ad_before_content( $wp_customize ) {    
    
    $wp_customize->add_section( 'ad_bc_post_settings', array(
        'title'    => __( 'Before Content AD Settings', 'blossom-feminine-pro' ),
        'priority' => 14,
        'panel'    => 'ad_settings'
    ) );
    ...
    $wp_customize->add_control(
		new Blossom_Feminine_Pro_Toggle_Control( 
			...
			array(
				...
				'label'       => __( 'Enable AD Before Content', 'blossom-feminine-pro' ),
                'description' => __( 'Enable AD Before Content in single post page.', 'blossom-feminine-pro' ),
			)
		)
	);
    ...
    $wp_customize->add_control(
		new Blossom_Feminine_Pro_Toggle_Control( 
			...
			array(
				'section' => 'ad_bc_post_settings',
				'label'   => __( 'Enable Before Content AD Code', 'blossom-feminine-pro' ),
			)
		)
	);
    ...
    $wp_customize->add_control( 
        new Blossom_Feminine_Pro_Code_Control(
    		...
    		array(
    			'section'	  => 'ad_bc_post_settings',
    			'label'		  => __( 'Before Content AD Code', 'blossom-feminine-pro' ),
                'description' => __( 'Paste your Adsense, ad code here to show ads before content in single post page.', 'blossom-feminine-pro' ),
    			'choices'     => array(
			        'language' => 'javascript',
			        'theme'    => 'monokai', //options are 'monokai', 'material' & 'elegant'
                    'height'   => 250,
                ), 
                'active_callback' => 'blossom_feminine_pro_adbc_ac'     		
            )
        )		
    );
    ...
    $wp_customize->add_control(
       new WP_Customize_Cropped_Image_Control(
           ...
           'bc_post_ad',
           array(
               'label'           => __( 'Upload Before Content AD', 'blossom-feminine-pro' ),
               'section'         => 'ad_bc_post_settings',
               'width'           => 920,
               'height'          => 90,
               'active_callback' => 'blossom_feminine_pro_adbc_ac'
    ...
    $wp_customize->add_control(
	   'bc_post_ad_link',
		array(
			'section'         => 'ad_bc_post_settings',
			'label'	          => __( 'Before Content AD Link', 'blossom-feminine-pro' ),
			'type'            => 'text',
            'active_callback' => 'blossom_feminine_pro_adbc_ac'
		)		
	);
...
add_action( 'customize_register', 'blossom_feminine_pro_customize_register_ad_before_content' );   

/**
 * Active Callback
*/
function blossom_feminine_pro_adbc_ac( $control ){

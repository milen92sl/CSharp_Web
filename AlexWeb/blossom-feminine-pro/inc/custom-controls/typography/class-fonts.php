...
if ( class_exists( 'Blossom_Feminine_Pro_Fonts' ) ) {
	return;
}

final class Blossom_Feminine_Pro_Fonts {

	/**
	 * One instance of Blossom_Feminine_Pro_Fonts
	 *
	 * @var Blossom_Feminine_Pro_Fonts
	 */
	...
	public static function get_standard_fonts() {
		return apply_filters( 'rara-fonts/fonts/standard_fonts', array(
    		'georgia-serif' => array(
    			'label' => _x( 'Georgia', 'font style', 'blossom-feminine-pro' ),
    			'stack' => 'georgia-serif',
    		),
            'palatino-serif' => array(
    			'label' => _x( 'Palatino Linotype, Book Antiqua, Palatino', 'font style', 'blossom-feminine-pro' ),
    			'stack' => 'palatino-serif',
    		),
            'times-serif' => array(
    			'label' => _x( 'Times New Roman, Times', 'font style', 'blossom-feminine-pro' ),
    			'stack' => 'times-serif',
    		),
            'arial-helvetica' => array(
    			'label' => _x( 'Arial, Helvetica', 'font style', 'blossom-feminine-pro' ),
    			'stack' => 'arial-helvetica',
    		),
            'arial-gadget' => array(
    			'label' => _x( 'Arial Black, Gadget', 'font style', 'blossom-feminine-pro' ),
    			'stack' => 'arial-gadget',
    		),
    		'comic-cursive' => array(
    			'label' => _x( 'Comic Sans MS, cursive', 'font style', 'blossom-feminine-pro' ),
    			'stack' => 'comic-cursive',
    		),
    		'impact-charcoal'  => array(
    			'label' => _x( 'Impact, Charcoal', 'font style', 'blossom-feminine-pro' ),
    			'stack' => 'impact-charcoal',
    		),
            'lucida' => array(
    			'label' => _x( 'Lucida Sans Unicode, Lucida Grande', 'font style', 'blossom-feminine-pro' ),
    			'stack' => 'lucida',
    		),
            'tahoma-geneva' => array(
    			'label' => _x( 'Tahoma, Geneva', 'font style', 'blossom-feminine-pro' ),
    			'stack' => 'tahoma-geneva',
    		),
    		'trebuchet-helvetica' => array(
    			'label' => _x( 'Trebuchet MS, Helvetica', 'font style', 'blossom-feminine-pro' ),
    			'stack' => 'trebuchet-helvetica',
    		),
    		'verdana-geneva'  => array(
    			'label' => _x( 'Verdana, Geneva', 'font style', 'blossom-feminine-pro' ),
    			'stack' => 'verdana-geneva',
    		),
            'courier' => array(
    			'label' => _x( 'Courier New, Courier', 'font style', 'blossom-feminine-pro' ),
    			'stack' => 'courier',
    		),
            'lucida-monaco' => array(
    			'label' => _x( 'Lucida Console, Monaco', 'font style', 'blossom-feminine-pro' ),
    			'stack' => 'lucida-monaco',
    		)
    	));
	}
	...
	public static function get_all_variants() {
		return apply_filters( 'blossom-feminine-fonts/fonts/font_variants', array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'blossom-feminine-pro' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'blossom-feminine-pro' ),
			'200'       => esc_attr__( 'Light 200', 'blossom-feminine-pro' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'blossom-feminine-pro' ),
			'300'       => esc_attr__( 'Book 300', 'blossom-feminine-pro' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'blossom-feminine-pro' ),
			'regular'   => esc_attr__( 'Normal 400', 'blossom-feminine-pro' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'blossom-feminine-pro' ),
			'500'       => esc_attr__( 'Medium 500', 'blossom-feminine-pro' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'blossom-feminine-pro' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'blossom-feminine-pro' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'blossom-feminine-pro' ),
			'700'       => esc_attr__( 'Bold 700', 'blossom-feminine-pro' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'blossom-feminine-pro' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'blossom-feminine-pro' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'blossom-feminine-pro' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'blossom-feminine-pro' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'blossom-feminine-pro' ),
		) );
	}

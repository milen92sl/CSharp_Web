 ...
 */
class Blossom_Feminine_Pro_Code_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'code', get_template_directory_uri() . '/inc/custom-controls/code/code.js', array( 'jquery', 'customize-base', 'dynamic-control', 'codemirror' ), false, true );
		wp_enqueue_style( 'code', get_template_directory_uri() . '/inc/custom-controls/code/code.css', null );

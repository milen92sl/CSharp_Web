<?php
/**
 * Blossom Feminine Pro Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Blossom_Feminine_Pro_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Blossom_Feminine_Pro_Repeater_Setting extends WP_Customize_Setting {

	...
	function license_page() {
        ...
        <div class="wrap getting-started">
			...
			<div class="intro-wrap">
				<div class="intro">
					<h3><?php printf( __( 'Getting started with %1$s v%2$s', 'blossom-feminine-pro' ), BLOSSOM_FEMININE_PRO_THEME_NAME, BLOSSOM_FEMININE_PRO_THEME_VERSION ); ?></h3>
                    <h4><?php printf( __( 'You will find everything you need to get started with %1$s below.', 'blossom-feminine-pro' ), BLOSSOM_FEMININE_PRO_THEME_NAME ); ?></h4>
				</div>
			</div><!-- .intro-wrap -->
			<div class="panels">
				<ul class="inline-list">
					<li class="current">
                        <a id="plugins" href="javascript:void(0);">
                            ...
                            <?php esc_html_e( 'Recommended Plugins', 'blossom-feminine-pro' ); ?>
                        </a>
                    </li>
					<li>
                        <a id="help" href="javascript:void(0);">
                            ...
                            <?php esc_html_e( 'Getting Started', 'blossom-feminine-pro' ); ?>
                        </a>
                    </li>
					<li>
                        <a id="support" href="javascript:void(0);">
                            ...
                            <?php esc_html_e( 'FAQ\'s &amp; Support', 'blossom-feminine-pro' ); ?>
                        </a>
                    </li>
					<li>
                        <a id="themeclub" href="javascript:void(0);">
                            ...
                            <?php esc_html_e( 'Theme Club', 'blossom-feminine-pro' ); ?>
                        </a>
                    </li>
				</ul>
	...
	function activate_license() {
		...
		if ( is_wp_error( $response ) || 200 !== wp_remote_retrieve_response_code( $response ) ) {
			...
			if ( is_wp_error( $response ) ) {
				...
				$message = __( 'An error occurred, please try again.', 'blossom-feminine-pro' );
			}
			...
			if ( false === $license_data->success ) {
				...
				switch( $license_data->error ) {
					...
					case 'expired' :
						...
						$message = sprintf(
							__( 'Your license key expired on %s.', 'blossom-feminine-pro' ),
					...
					case 'revoked' :
						...
						$message = __( 'Your license key has been disabled.', 'blossom-feminine-pro' );
						break;

					case 'missing' :

						$message = __( 'Invalid license.', 'blossom-feminine-pro' );
						break;

					case 'invalid' :
					case 'site_inactive' :

						$message = __( 'Your license is not active for this URL.', 'blossom-feminine-pro' );
						break;

					case 'item_name_mismatch' :

						$message = sprintf( __( 'This appears to be an invalid license key for %s.', 'blossom-feminine-pro' ), $this->item_name );
						break;

					case 'no_activations_left':

						$message = __( 'Your license key has reached its activation limit.', 'blossom-feminine-pro' );
						break;

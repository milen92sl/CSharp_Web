<?php
/**
 * Blossom Spa Pro Customizer Slider Control.
 * 
...
if ( ! class_exists( 'Blossom_Spa_Pro_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Blossom_Spa_Pro_Slider_Control extends WP_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'blossom-spa-pro-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'blossom-spa-pro-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }

<?php
/**
 * Blossom Spa Pro Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Blossom_Spa_Pro_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Blossom_Spa_Pro_Repeater_Setting extends WP_Customize_Setting {

<?php
/**
 * Blossom Spa Pro Customizer Notification System.
 *
 ...
 */
class Blossom_Spa_Pro_Customizer_Notice {
	...
	/**
	 * The single instance of Blossom_Spa_Pro_Customizer_Notice
	 *
	 * @var Blossom_Spa_Pro_Customizer_Notice $instance The Blossom_Spa_Pro_Customizer_Notice instance.
	 */
	...
	/**
	 * The Main Blossom_Spa_Pro_Customizer_Notice instance.
	 *
	 * We make sure that only one instance of Blossom_Spa_Pro_Customizer_Notice exists in the memory at one time.
	 *
	 * @param array $config The configuration array.
	 */
	public static function init( $config ) {
		if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Blossom_Spa_Pro_Customizer_Notice ) ) {
			self::$instance = new Blossom_Spa_Pro_Customizer_Notice;
	...
	public function setup_config() {
		...
		$blossom_spa_pro_recommended_plugins = array();
		
		if ( isset( $this->recommended_plugins ) ) {
			$blossom_spa_pro_recommended_plugins = $this->recommended_plugins;
		}
	...
	public function scripts_for_customizer() {
		...
		wp_enqueue_style( 'blossom-spa-pro-customizer-notice', get_template_directory_uri() . '/inc/customizer-plugin-recommend/customizer-notice/css/customizer-notice.css', null );
		...
		wp_enqueue_script( 'blossom-spa-pro-customizer-notice', get_template_directory_uri() . '/inc/customizer-plugin-recommend/customizer-notice/js/customizer-notice.js', array( 'jquery', 'customize-controls' ), BLOSSOM_SPA_PRO_THEME_VERSION, true );
		wp_localize_script(
			'blossom-spa-pro-customizer-notice', 
            'customizer_notice_data', 
            array(
				'ajaxurl'            => admin_url( 'admin-ajax.php' ),
				'template_directory' => get_template_directory_uri(),
				'base_path'          => admin_url(),
				'activating_string'  => __( 'Activating', 'blossom-spa-pro' ),
			)
		);
	}
	...
	public function customize_register_notice( $wp_customize ) {
		/**
		 * Include the Blossom_Spa_Pro_Customizer_Notice_Section class.
		 */
		...
		$wp_customize->register_section_type( 'Blossom_Spa_Pro_Customizer_Notice_Section' );

		$wp_customize->add_section(
			new Blossom_Spa_Pro_Customizer_Notice_Section(
				$wp_customize,
	...
	public function dismiss_recommended_plugins_callback() {
		...
		if ( ! empty( $action_id ) ) {
			...
			update_option( 'blossom_spa_pro_show_recommended_plugins', $show_recommended_plugins );
		}

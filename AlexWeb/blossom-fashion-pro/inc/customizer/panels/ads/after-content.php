...
function blossom_fashion_pro_customize_register_ad_after_content( $wp_customize ) {    
    
    $wp_customize->add_section( 'ad_ac_post_settings', array(
        'title'       => __( 'After Content AD Settings', 'blossom-fashion-pro' ),
        'priority'    => 15,
        'panel'       => 'ad_settings'
    ) );
    ...
    $wp_customize->add_control(
		new Blossom_Fashion_Pro_Toggle_Control( 
			...
			array(
				...
				'label'       => __( 'Enable AD After Content', 'blossom-fashion-pro' ),
                'description' => __( 'Enable AD After Content in single post page.', 'blossom-fashion-pro' ),
			)
		)
	);
    ...
    $wp_customize->add_control(
		new Blossom_Fashion_Pro_Toggle_Control( 
			...
			array(
				'section' => 'ad_ac_post_settings',
				'label'   => __( 'Enable After Content AD Code', 'blossom-fashion-pro' ),
			)
		)
	);
    ...
    $wp_customize->add_control( 
        new Blossom_Fashion_Pro_Code_Control(
    		...
    		array(
    			'section'	  => 'ad_ac_post_settings',
    			'label'		  => __( 'After Content AD Code', 'blossom-fashion-pro' ),
                'description' => __( 'Paste your Adsense, ad code here to show ads after content in single post page.', 'blossom-fashion-pro' ),
    			'choices'     => array(
			        'language' => 'javascript',
			        'theme'    => 'monokai', //options are 'monokai', 'material' & 'elegant'
                    'height'   => 250,
                ), 
                'active_callback' => 'blossom_fashion_pro_adac_ac'     		
            )
        )		
    );
    ...
    $wp_customize->add_control(
       new WP_Customize_Cropped_Image_Control(
           ...
           'ac_post_ad',
           array(
               'label'           => __( 'Upload After Content AD', 'blossom-fashion-pro' ),
               'section'         => 'ad_ac_post_settings',
               'width'           => 728,
               'height'          => 90,
               'active_callback' => 'blossom_fashion_pro_adac_ac'
    ...
    $wp_customize->add_control(
	   'ac_post_ad_link',
		array(
			'section'         => 'ad_ac_post_settings',
			'label'	          => __( 'After Content AD Link', 'blossom-fashion-pro' ),
			'type'            => 'text',
            'active_callback' => 'blossom_fashion_pro_adac_ac'
		)		
	);
...
add_action( 'customize_register', 'blossom_fashion_pro_customize_register_ad_after_content' );    

/**
 * Active Callback
*/
function blossom_fashion_pro_adac_ac( $control ){

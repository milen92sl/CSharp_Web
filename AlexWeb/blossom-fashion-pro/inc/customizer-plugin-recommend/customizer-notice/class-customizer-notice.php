<?php
/**
 * Blossom Fashion Pro Customizer Notification System.
 *
 * @package Blossom Fashion Pro
 */

/**
 * TI Customizer Notify Class
 */
class Blossom_Fashion_Pro_Customizer_Notice {
	...
	/**
	 * The single instance of Blossom_Fashion_Pro_Customizer_Notice
	 *
	 * @var Blossom_Fashion_Pro_Customizer_Notice $instance The Blossom_Fashion_Pro_Customizer_Notice instance.
	 */
	...
	/**
	 * The Main Blossom_Fashion_Pro_Customizer_Notice instance.
	 *
	 * We make sure that only one instance of Blossom_Fashion_Pro_Customizer_Notice exists in the memory at one time.
	 *
	 * @param array $config The configuration array.
	 */
	public static function init($config) {
		if (!isset(self::$instance) && !(self::$instance instanceof Blossom_Fashion_Pro_Customizer_Notice)) {
			self::$instance = new Blossom_Fashion_Pro_Customizer_Notice;
	...
	public function setup_config() {
		...
		global $blossom_fashion_pro_recommended_plugins;
		...
		$blossom_fashion_pro_recommended_plugins = array();

		if (isset($this->recommended_plugins)) {
			$blossom_fashion_pro_recommended_plugins = $this->recommended_plugins;
		}
	...
	public function scripts_for_customizer() {
		...
		wp_enqueue_style('blossom-fashion-pro-customizer-notice', get_template_directory_uri() . '/inc/customizer-plugin-recommend/customizer-notice/css/customizer-notice.css', array(), BLOSSOM_FASHION_PRO_THEME_VERSION);
		...
		wp_enqueue_script('blossom-fashion-pro-customizer-notice', get_template_directory_uri() . '/inc/customizer-plugin-recommend/customizer-notice/js/customizer-notice.js', array('customize-controls'), BLOSSOM_FASHION_PRO_THEME_VERSION);
		wp_localize_script(
			'blossom-fashion-pro-customizer-notice', 'customizer_notice_data', array(
				'ajaxurl' => admin_url('admin-ajax.php'),
				'template_directory' => get_template_directory_uri(),
				'base_path' => admin_url(),
				'activating_string' => __('Activating', 'blossom-fashion-pro'),
			)
		);
	...
	public function customize_register_notice($wp_customize) {
		...
		/**
		 * Include the Blossom_Fashion_Pro_Customizer_Notice_Section class.
		 */
		...
		$wp_customize->register_section_type('Blossom_Fashion_Pro_Customizer_Notice_Section');

		$wp_customize->add_section(
			new Blossom_Fashion_Pro_Customizer_Notice_Section(
				$wp_customize,
	...
	public function dismiss_recommended_plugins_callback() {
		...
		if (!empty($action_id)) {
			...
			$show_recommended_plugins = get_option('blossom_fashion_pro_show_recommended_plugins');
			...
			update_option('blossom_fashion_pro_show_recommended_plugins', $show_recommended_plugins);
		}

 ...
 * @access public
 */
class Blossom_Fashion_Pro_Customizer_Section_Notice extends WP_Customize_Section {
	...
	protected function render_template() {
		?>
		<# if ( !data.hide_notice ) { #>
			<li id="accordion-section-{{ data.id }}" class="blossom-fashion-pro-notice accordion-section control-section control-section-{{ data.type }} cannot-expand">
	...
	public function create_plugin_install_button($slug) {
		return Blossom_Fashion_Pro_Plugin_Install_Helper::instance()->get_button_html($slug);
	}
}

<?php
/**
 * Blossom Fashion Pro Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Blossom_Fashion_Pro_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Blossom_Fashion_Pro_Repeater_Setting extends WP_Customize_Setting {

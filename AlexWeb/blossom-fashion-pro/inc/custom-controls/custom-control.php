<?php
if( ! function_exists( 'blossom_fashion_pro_register_custom_controls' ) ) :
/**
 * Register Custom Controls
*/
function blossom_fashion_pro_register_custom_controls( $wp_customize ){
    ...
    $wp_customize->register_control_type( 'Blossom_Fashion_Pro_Code_Control' );
    $wp_customize->register_control_type( 'Blossom_Fashion_Pro_Radio_Buttonset_Control' );
    $wp_customize->register_control_type( 'Blossom_Fashion_Pro_Radio_Image_Control' );
    $wp_customize->register_control_type( 'Blossom_Fashion_Pro_Select_Control' );
    $wp_customize->register_control_type( 'Blossom_Fashion_Pro_Slider_Control' );
    $wp_customize->register_control_type( 'Blossom_Fashion_Control_Sortable' );
    $wp_customize->register_control_type( 'Blossom_Fashion_Pro_Toggle_Control' );
    $wp_customize->register_control_type( 'Blossom_Fashion_Pro_Typography_Control' );
        
}
endif;
add_action( 'customize_register', 'blossom_fashion_pro_register_custom_controls' );
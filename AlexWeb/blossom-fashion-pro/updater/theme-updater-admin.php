	...
	function license_page() {
        ...
        <div class="wrap getting-started">
			...
			<div class="intro-wrap">
				<div class="intro">
					<h3><?php printf( __( 'Getting started with %1$s v%2$s', 'blossom-fashion-pro' ), BLOSSOM_FASHION_PRO_THEME_NAME, BLOSSOM_FASHION_PRO_THEME_VERSION ); ?></h3>
                    <h4><?php printf( __( 'You will find everything you need to get started with %1$s below.', 'blossom-fashion-pro' ), BLOSSOM_FASHION_PRO_THEME_NAME ); ?></h4>
				</div>
			</div><!-- .intro-wrap -->
			<div class="panels">
				<ul class="inline-list">
					<li class="current">
                        <a id="plugins" href="javascript:void(0);">
                            ...
                            <?php esc_html_e( 'Recommended Plugins', 'blossom-fashion-pro' ); ?>
                        </a>
                    </li>
					<li>
                        <a id="help" href="javascript:void(0);">
                            ...
                            <?php esc_html_e( 'Getting Started', 'blossom-fashion-pro' ); ?>
                        </a>
                    </li>
					<li>
                        <a id="support" href="javascript:void(0);">
                            ...
                            <?php esc_html_e( 'FAQ\'s &amp; Support', 'blossom-fashion-pro' ); ?>
                        </a>
                    </li>
					<li>
                        <a id="themeclub" href="javascript:void(0);">
                            ...
                            <?php esc_html_e( 'Theme Club', 'blossom-fashion-pro' ); ?>
                        </a>
                    </li>
				</ul>
	...
	function activate_license() {
		...
		if ( is_wp_error( $response ) || 200 !== wp_remote_retrieve_response_code( $response ) ) {
			...
			if ( is_wp_error( $response ) ) {
				...
				$message = __( 'An error occurred, please try again.', 'blossom-fashion-pro' );
			}
			...
			if ( false === $license_data->success ) {
				...
				switch( $license_data->error ) {
					...
					case 'expired' :
						...
						$message = sprintf(
							__( 'Your license key expired on %s.', 'blossom-fashion-pro' ),
					...
					case 'revoked' :
						...
						$message = __( 'Your license key has been disabled.', 'blossom-fashion-pro' );
						break;

					case 'missing' :

						$message = __( 'Invalid license.', 'blossom-fashion-pro' );
						break;

					case 'invalid' :
					case 'site_inactive' :

						$message = __( 'Your license is not active for this URL.', 'blossom-fashion-pro' );
						break;

					case 'item_name_mismatch' :

						$message = sprintf( __( 'This appears to be an invalid license key for %s.', 'blossom-fashion-pro' ), $this->item_name );
						break;

					case 'no_activations_left':

						$message = __( 'Your license key has reached its activation limit.', 'blossom-fashion-pro' );
						break;

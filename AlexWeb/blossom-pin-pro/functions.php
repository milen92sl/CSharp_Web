<?php
/**
 * Blossom Pin Pro functions and definitions
 *
...
if ( ! defined( 'BLOSSOM_PIN_PRO_THEME_VERSION' ) && ! defined( 'BLOSSOM_PIN_PRO_THEME_NAME' ) ) {
	$theme_data = wp_get_theme();	
	define ( 'BLOSSOM_PIN_PRO_THEME_VERSION', $theme_data->get( 'Version' ) );
	define ( 'BLOSSOM_PIN_PRO_THEME_NAME', $theme_data->get( 'Name' ) );
}

<?php
/**
 * Blossom Pin Pro Customizer Slider Control.
 * 
...
if ( ! class_exists( 'Blossom_Pin_Pro_Slider_Control' ) ){
	/**
	 * Slider control (range).
    */
	class Blossom_Pin_Pro_Slider_Control extends WP_Customize_Control {
        ...
        public function enqueue() {            
            wp_enqueue_style( 'blossom-pin-pro-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.css', null );
            wp_enqueue_script( 'blossom-pin-pro-slider', get_template_directory_uri() . '/inc/custom-controls/slider/slider.js', array( 'jquery' ), false, true ); //for slider                
        }

<?php
/**
 * Blossom Pin Pro Repeater Customizer Setting.
 * 
...
if ( ! class_exists( 'Blossom_Pin_Pro_Repeater_Setting' ) ) {

	/**
	 * Repeater Settings.
	 */
	class Blossom_Pin_Pro_Repeater_Setting extends WP_Customize_Setting {

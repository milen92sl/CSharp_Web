<?php
/**
 * Blossom Pin Pro Customizer Code Control.
 *
...
if( ! class_exists( 'Blossom_Pin_Pro_Code_Control' ) ){
    /**
     * Adds a "code" control, using CodeMirror.
     */
    class Blossom_Pin_Pro_Code_Control extends WP_Customize_Control {
    	...
    	public function enqueue() {
    		...
    		wp_enqueue_script( 'blossom-pin-pro-code', get_template_directory_uri() . '/inc/custom-controls/code/code.js', array( 'jquery', 'customize-base', 'dynamic-control', 'codemirror' ), false, true );
    		wp_enqueue_style( 'blossom-pin-pro-code', get_template_directory_uri() . '/inc/custom-controls/code/code.css', null );
